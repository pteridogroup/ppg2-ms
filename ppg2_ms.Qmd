...
Two subsequent classifications extended the taxonomic scope to genera [@christenhusz2011linear; @christenhusz2014trends], but due in part to their drastic consolidation of genera and families, they were not widely accepted by the broader pteridological community [@schuettpelz2018are].
...
When PPG joined WFO as a TEN, data for ferns and lycophytes were already in Rhakhis, but the classification scheme was based on the World Checklist of Vascular Plants [@govaertsWorldChecklistVascular2021], which deviated substantially from PPG I [-@pteridophytephylogenygroupi2016communityderived].
