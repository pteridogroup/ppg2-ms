...
The classification to receive wide acceptance was Pteridophyte Phylogeny Group (PPG) I [-@pteridophytephylogenygroupi2016communityderived].
...
When PPG joined WFO as a TEN, data for ferns and lycophytes were already in Rhakhis, but the classification scheme was based on the World Checklist of Vascular Plants [@govaertsWorldChecklistVascular2021], which deviated substantially from PPG I (2016).
...
The number of taxa at the level of species and below (>13,000 accepted species) precludes publishing those names here, but the full classification (extending to subspecific ranks) is available on our website (<https://pteridogroup.github.io/>) and WFO (<https://www.worldfloraonline.org/>).
