...
Ferns and lycophytes, which together compose the paraphyletic pteridophytes, are globally important plant groups that have shown remarkable resilience during their long phylogenetic history [@li2025fernsa].
...
PPG II includes one genus not included in World Ferns v25.12 (*Thysanosoria* A.Gepp) and lacks six genera included there (*Brownseya* Li Bing Zhang, L.D.Sheph., D.K.Chen, X.M.Zhou & H.He, *Davallodes* (Copel.) Copel., *Orthiopteris* Copel., *Physematium* Kaulf., *Podosorus* Holttum, and *Sticheroides* L.V.Lima, Salino & T.E.Almeida).
...
#|   PPG I did not treat nothotaxa. World Ferns does not treat class, subclass, suborder, or subfamily."

wf_taxa_count_wide <- wf_taxa_count |>
