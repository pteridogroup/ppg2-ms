...
authors <- read_csv("data/ppg2_author_list.csv") |>
  ...
  mutate(
    ...
    last_name_order = case_when(
      ...
      name == "Julián Mostacero Giannangeli" ~ "Mostacero",
      .default = last_name
    )
  ) |>
...
To maintain taxonomic data, PPG partners with World Flora Online (WFO), a large-scale database project to provide a consensus taxonomy for all plants (<https://www.worldfloraonline.org/>).
