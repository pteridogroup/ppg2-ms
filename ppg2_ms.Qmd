...
Recommended citation: PPG II (2026). This project was organized by Joel H. Nitta^1^, Michael Hassler^2^, Harald Schneider^3^, Christopher Hoess^4^, Carl Rothfels^5^, and Eric Schuettpelz^6^; with additional contributions from (in alphabetical order): `r other_authors`
...
This responsivity will benefit stakeholders who need an up-to-date, standardized taxonomy for ferns and lycophytes, while simultaneously providing through the versioning system and DOI the ability to unambiguously reference a specific snapshot of the classification.
...
The large number of taxa at the level of species and below (>13,000 accepted species) precludes publishing those names here, but the full classification (extending to infraspecific ranks) is available on our website (<https://pteridogroup.github.io/>) and WFO (<https://www.worldfloraonline.org/>).
