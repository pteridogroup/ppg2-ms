...
While a complete description of every area of taxonomic uncertainty is beyond the scope of this paper, a summary may be found in @tbl-uncertain.
...
#| label: tbl-uncertain
#| tbl-cap:
#|   - "Uncertain relationships in pteridophytes. Node indicates numbered nodes in Fig. 1."
...
fig1_cap <- glue::glue("
  ...
  Numbers at nodes indicate uncertain relationships (Table 3).
  ") |>
  as.character() |>
  str_remove_all("//\n") |>
  str_squish()
...
# unfortunately not working for now, but leave in for later
...
tree_fig <-
  ...
  # unfortunately we can't use linetype and geom_strip together, so
  # comment this out until
  # https://github.com/YuLab-SMU/ggtree/issues/676
  # gets fixed
