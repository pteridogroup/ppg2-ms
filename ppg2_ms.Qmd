---
title: "An update of the Pteripophyte Phylogeny Group classification for extant ferns and lycophytes: PPG II"
format: docx
...
authors <- read_csv("data/ppg2_author_list.csv") |>
  ...
  mutate(
    other_author = str_detect(name, "Nitta|Rothfels|Schneider|Schuettpelz", negate = TRUE),
    auth_num = seq(nrow(.)),
...
Recommended citation: PPG II (2026). This project was organized by Joel H. Nitta\*^1^, Carl Rothfels^2^, Harald Schneider^3^, Eric Schuettpelz\*^4^; with additional contributions from (in alphabetical order): `r other_authors`
...
The initial version of the taxonomic data was based on a copy of the World Ferns database provided by Michael Hassler (<https://www.worldplants.de/world-ferns/ferns-and-lycophytes-list>), which was imported into Rhakhis and edited to reflect accepted taxonomic proposals from our voting process.
