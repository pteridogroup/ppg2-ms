...
clean_ppg <- function(ppg_raw) {
  ...
  ppg_raw |>
    ...
    # TODO remove when ppg data are updated
    # Implement changes that haven't been downloaded from Rhakhis yet
    dct_modify_row(
      scientificName = "Galactodenia",
      scientificNameAuthorship = "Sundue & Labiak",
      nomenclaturalStatus = "valid"
    ) |>
    dct_modify_row(
      scientificName = "Zealandia",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-6500000517",
      nomenclaturalStatus = "valid"
    ) |>
    dct_modify_row(
      scientificName = "Dendroconche",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-6500000517",
      nomenclaturalStatus = "valid"
    ) |>
    dct_add_row(
      scientificName = "Sticheroides",
      scientificNameAuthorship = "L.V.Lima, Salino & T.E.Almeida",
      taxonRank = "genus",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-7000000251",
      nomenclaturalStatus = "valid"
    ) |>
    # Zealandia species
    dct_modify_row(
      scientificName = "Zealandia novaezealandiae",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4100001083"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris novaezealandiae",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000034941"
    ) |>
    dct_modify_row(
      scientificName = "Zealandia powellii",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4100001083"
    ) |>
    dct_modify_row(
      scientificName = "Microsorum powellii",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000034942"
    ) |>
    dct_modify_row(
      scientificName = "Zealandia pustulata",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4100001083"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris pustulata",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000034943"
    ) |>
    dct_modify_row(
      scientificName = "Zealandia vieillardii",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4100001083"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris vieillardii",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000034944"
    ) |>
    # Sticheroides
    dct_add_row(
      scientificName = "Sticheroides milnei",
      scientificNameAuthorship = "(Ching) L.V.Lima, Salino & T.E.Almeida",
      taxonRank = "species",
      taxonomicStatus = "accepted",
      parentNameUsageID = "9b2f2c50b4f2b5420e64e2110c988c82"
    ) |>
    dct_add_row(
      scientificName = "Sticheroides truncata",
      scientificNameAuthorship = "(Willd.) L.V.Lima, Salino & T.E.Almeida",
      taxonRank = "species",
      taxonomicStatus = "accepted",
      parentNameUsageID = "9b2f2c50b4f2b5420e64e2110c988c82"
    ) |>
    # Dendroconche species
    dct_modify_row(
      scientificName = "Dendroconche ampla",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4000011073"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris ampla",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000031925"
    ) |>
    dct_modify_row(
      scientificName = "Dendroconche annabellae",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4000011073"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris annabellae",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-0001035560"
    ) |>
    dct_modify_row(
      scientificName = "Dendroconche kingii",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4000011073"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris kingii",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-0000148099"
    ) |>
    dct_modify_row(
      scientificName = "Dendroconche latilobata",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4000011073"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris latilobata",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000031926"
    ) |>
    dct_modify_row(
      scientificName = "Dendroconche linguiforme",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4000011073"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris linguiformis",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000031927"
    ) |>
    dct_modify_row(
      scientificName = "Dendroconche sayeri",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4000011073"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris sayeri",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000031928"
    ) |>
    dct_modify_row(
      scientificName = "Dendroconche scandens",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4000011073"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris scandens",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000031929"
    ) |>
    dct_modify_row(
      scientificName = "Dendroconche varians",
      taxonomicStatus = "accepted",
      parentNameUsageID = "wfo-4000011073"
    ) |>
    dct_modify_row(
      scientificName = "Lecanopteris varians",
      taxonomicStatus = "synonym",
      acceptedNameUsageID = "wfo-1000031930"
    )
}
